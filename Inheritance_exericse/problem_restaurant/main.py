from problem_restaurant.project.beverage.beverage import Beverage
from problem_restaurant.project.food.soup import Soup
from problem_restaurant.project.product import Product
